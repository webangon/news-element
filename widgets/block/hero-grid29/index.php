    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .herogrid29 >div[class^="fw-col-md"]' => 'padding: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .herogrid29' => 'margin-right: -{{SIZE}}{{UNIT}};margin-left: -{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px'],
                'selectors' => [
                    '{{WRAPPER}} .firstblock .inrwrp' => 'height: {{SIZE}}{{UNIT}};',
                ],
