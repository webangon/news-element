...
class Internal_URL extends Data_Tag {
	...
	public function get_title() {
		return esc_html__( 'Internal URL', 'news-element' );
	}
	...
	protected function register_controls() {
		$this->add_control( 'type', [
			...
			'options' => [
				'post' => esc_html__( 'Content', 'news-element' ),
				'taxonomy' => esc_html__( 'Taxonomy', 'news-element' ),
				'attachment' => esc_html__( 'Media', 'news-element' ),
				'author' => esc_html__( 'Author', 'news-element' ),
			],
		] );

		$this->add_control( 'post_id', [
			'label' => esc_html__( 'Search & Select', 'news-element' ),
