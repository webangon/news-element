...
class Featured_Image_Data extends Tag {
	...
	public function get_title() {
		return esc_html__( 'Featured Image Data', 'news-element' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'attachment_data',
			[
				'label' => esc_html__( 'Data', 'news-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'title',
				'options' => [
					'title' => esc_html__( 'Title', 'news-element' ),
					'alt' => esc_html__( 'Alt', 'news-element' ),
					'caption' => esc_html__( 'Caption', 'news-element' ),
					'description' => esc_html__( 'Description', 'news-element' ),
					'src' => esc_html__( 'File URL', 'news-element' ),
					'href' => esc_html__( 'Attachment URL', 'news-element' ),
				],
			]
		);
	}
