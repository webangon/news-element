...
class Author_URL extends Data_Tag {
	...
	public function get_title() {
		return esc_html__( 'Author URL', 'news-element' );
	}
	...
	protected function register_controls() {
		$this->add_control(
			'url',
			[
				'label' => esc_html__( 'URL', 'news-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'archive',
				'options' => [
					'archive' => esc_html__( 'Author Archive', 'news-element' ),
					'website' => esc_html__( 'Author Website', 'news-element' ),
				],
			]
		);
	}
