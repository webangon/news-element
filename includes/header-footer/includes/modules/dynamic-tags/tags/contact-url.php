...
class Contact_URL extends Tag {
	...
	public function get_title() {
		return esc_html__( 'Contact URL', 'news-element' );
	}
	...
	protected function register_controls() {
		$this->add_control(
			'link_type',
			[
				'label' => esc_html__( 'Type', 'news-element' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => '— ' . esc_html__( 'Select', 'news-element' ) . ' —',
					'email' => esc_html__( 'Email', 'news-element' ),
					'tel' => esc_html__( 'Tel', 'news-element' ),
					'sms' => esc_html__( 'SMS', 'news-element' ),
					'whatsapp' => esc_html__( 'WhatsApp', 'news-element' ),
					'skype' => esc_html__( 'Skype', 'news-element' ),
					'messenger' => esc_html__( 'Messenger', 'news-element' ),
					'viber' => esc_html__( 'Viber', 'news-element' ),
					'waze' => esc_html__( 'Waze', 'news-element' ),
					'google_calendar' => esc_html__( 'Google Calendar', 'news-element' ),
					'outlook_calendar' => esc_html__( 'Outlook Calendar', 'news-element' ),
					'yahoo_calendar' => esc_html__( 'Yahoo Calendar', 'news-element' ),
				],
			]
		);
		...
		$this->add_control(
			'mail_to',
			[
				'label' => esc_html__( 'Email', 'news-element' ),
		...
		$this->add_control(
			'mail_subject',
			[
				'label' => esc_html__( 'Subject', 'news-element' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'email',
		...
		$this->add_control(
			'mail_body',
			[
				'label' => esc_html__( 'Message', 'news-element' ),
		...
		$this->add_control(
			'tel_number',
			[
				'label' => esc_html__( 'Number', 'news-element' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
					'link_type' => [
						'tel',
		...
		$this->add_control(
			'username',
			[
				'label' => esc_html__( 'Username', 'news-element' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
		...
		$this->add_control(
			'viber_action',
			[
				'label' => esc_html__( 'Action', 'news-element' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'contact' => esc_html__( 'Contact', 'news-element' ),
					'add' => esc_html__( 'Add', 'news-element' ),
				],
				'default' => 'contact',
				'condition' => [
					'link_type' => 'viber',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'call' => esc_html__( 'Call', 'news-element' ),
					'chat' => esc_html__( 'Chat', 'news-element' ),
					'userinfo' => esc_html__( 'Show Profile', 'news-element' ),
					'add' => esc_html__( 'Add to Contacts', 'news-element' ),
					'voicemail' => esc_html__( 'Send Voice Mail', 'news-element' ),
				],
				'default' => 'call',
				'condition' => [
					'link_type' => 'skype',
		...
		$this->add_control(
			'waze_address',
			[
				'label' => esc_html__( 'Location', 'news-element' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'waze',
		...
		$this->add_control(
			'event_description',
			[
				'label' => esc_html__( 'Description', 'news-element' ),
				'type' => Controls_Manager::TEXTAREA,
				'condition' => [
					'link_type' => [
						'google_calendar',
		...
		$this->add_control(
			'event_start_date',
			[
				'label' => esc_html__( 'Start', 'news-element' ),
		...
		$this->add_control(
			'event_end_date',
			[
				'label' => esc_html__( 'End', 'news-element' ),
				'type' => Controls_Manager::DATE_TIME,
				'condition' => [
					'link_type' => [
						'google_calendar',
