...
abstract class Theme_Document extends Library_Document {
	...
	public static function get_editor_panel_config() {
		...
		if ( true === $document_config['support_site_editor'] ) {
			$panel_config['messages']['publish_notification'] = __( 'Congrats! Your Site Part is Live', 'news-element' );
		}
	...
	public function get_location_label() {
		...
		if ( ! $supported ) {
			$label .= ' (' . __( 'Unsupported', 'news-element' ) . ')';
		}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'preview_settings',
			[
				'label' => __( 'Preview Settings', 'news-element' ),
		...
		$this->add_control(
			'preview_type',
			[
				'label' => __( 'Preview Dynamic Content as', 'news-element' ),
				'label_block' => true,
		...
		$this->add_control(
			'preview_search_term',
			[
				'label' => __( 'Search Term', 'news-element' ),
				'export' => false,
				'condition' => [
					'preview_type' => 'search',
				],
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Apply & Preview', 'news-element' ),
				'label_block' => true,
				'show_label' => false,
				'text' => __( 'Apply & Preview', 'news-element' ),
				'separator' => 'none',
	...
	private function inject_html_tag_control() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'HTML Tag', 'news-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'div',
