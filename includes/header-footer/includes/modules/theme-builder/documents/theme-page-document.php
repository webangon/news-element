...
abstract class Theme_Page_Document extends Theme_Document {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'page_template',
			[
				'label' => __( 'Page Layout', 'news-element' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __( 'Default', 'news-element' ),
					PageTemplatesModule::TEMPLATE_CANVAS => __( 'Elementor Canvas', 'news-element' ),
					PageTemplatesModule::TEMPLATE_HEADER_FOOTER => __( 'Elementor Full Width', 'news-element' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw' => __( 'Default Page Template from your theme', 'news-element' ),
				'separator' => 'none',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'No header, no footer, just Elementor', 'news-element' ),
				'separator' => 'none',
				'content_classes' => 'elementor-descriptor',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'This template includes the header, full-width content and footer', 'news-element' ),
				'separator' => 'none',
				'content_classes' => 'elementor-descriptor',
				'condition' => [
