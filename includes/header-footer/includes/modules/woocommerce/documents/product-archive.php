...
class Product_Archive extends Archive {
	...
	public static function get_title() {
		return __( 'Products Archive', 'news-element' );
	}

	public static function get_plural_title() {
		return __( 'Products Archives', 'news-element' );
	}
	...
	protected static function get_site_editor_tooltip_data() {
		return [
			'title' => __( 'What is a Products Archive Template?', 'news-element' ),
			'content' => __( 'A products archive template allows you to easily design the layout and style of your WooCommerce shop page or other product archive pages - those pages that show a list of products, which may be filtered by terms such as categories, tags, etc.', 'news-element' ),
			'tip' => __( 'You can create multiple products archive templates, and assign each to different categories of products. This gives you the freedom to customize the appearance for each type of product being shown.', 'news-element' ),
	...
	public static function get_preview_as_options() {
		...
		$post_type_archives[ 'post_type_archive/' . $post_type ] = $post_type_object->label . ' ' . __( 'Archive', 'news-element' );
		...
		foreach ( $post_type_taxonomies as $slug => $object ) {
			$taxonomies[ 'taxonomy/' . $slug ] = $object->label . ' ' . __( 'Archive', 'news-element' );
		}
	...
	protected static function get_editor_panel_categories() {
		$categories = [
			'woocommerce-elements-archive' => [
				'title' => __( 'Product Archive', 'news-element' ),
			],
			// Move to top as active.
			'woocommerce-elements' => [
				'title' => __( 'WooCommerce', 'news-element' ),
				'active' => true,
			],
		];
