...
class Product extends Single_Base {
	...
	public static function get_title() {
		return __( 'Single Product', 'news-element' );
	}

	public static function get_plural_title() {
		return __( 'Single Products', 'news-element' );
	}
	...
	protected static function get_site_editor_tooltip_data() {
		return [
			'title' => __( 'What is a Single Product Template?', 'news-element' ),
			'content' => __( 'A single product template allows you to easily design the layout and style of WooCommerce single product pages, and apply that template to various conditions that you assign.', 'news-element' ),
			'tip' => __( 'You can create multiple single product templates, and assign each to different types of products, enabling a custom design for each group of similar products.', 'news-element' ),
	...
	protected static function get_editor_panel_categories() {
		$categories = [
			...
			'thepackkit-woo-product' => [
				'title' => __( 'LaStudio Kit Product', 'news-element' ),
				'active' => true,
			],
		];
