...
class Document extends Theme_Section_Document {
	...
	public static function get_title() {
		return esc_html__( 'Popup', 'news-element' );
	}

	public static function get_plural_title() {
		return esc_html__( 'Popups', 'news-element' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'popup_layout',
			[
				'label' => esc_html__( 'Layout', 'news-element' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'auto',
				'options' => [
					'auto' => esc_html__( 'Fit To Content', 'news-element' ),
					'fit_to_screen' => esc_html__( 'Fit To Screen', 'news-element' ),
		...
		$this->add_responsive_control(
			'height',
			[
				'label' => esc_html__( 'Custom Height', 'news-element' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 100,
		...
		$this->add_control(
			'content_position',
			[
				'label' => esc_html__( 'Content Position', 'news-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'top',
				'options' => [
					'top' => esc_html__( 'Top', 'news-element' ),
					'center' => esc_html__( 'Center', 'news-element' ),
					'bottom' => esc_html__( 'Bottom', 'news-element' ),
				],
				'condition' => [
					'height_type!' => 'auto',
				],
		...
		$this->add_responsive_control(
			'horizontal_position',
			[
				'label' => esc_html__( 'Horizontal', 'news-element' ),
		...
		$this->add_responsive_control(
			'vertical_position',
			[
				'label' => esc_html__( 'Vertical', 'news-element' ),
				'type' => Controls_Manager::CHOOSE,
				'toggle' => false,
				'default' => 'center',
				'options' => [
					'top' => [
						'title' => esc_html__( 'Top', 'news-element' ),
					...
					'bottom' => [
						'title' => esc_html__( 'Bottom', 'news-element' ),
		...
		$this->add_control(
			...
			[
				...
				'label_off' => esc_html__( 'Hide', 'news-element' ),
				'label_on' => esc_html__( 'Show', 'news-element' ),
				'default' => 'yes',
				'selectors' => [
		...
		$this->add_control(
			'close_button',
			[
				'label' => esc_html__( 'Close Button', 'news-element' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Hide', 'news-element' ),
				'label_on' => esc_html__( 'Show', 'news-element' ),
				'default' => 'yes',
		...
		$this->add_responsive_control(
			'entrance_animation',
			[
				'label' => esc_html__( 'Entrance Animation', 'news-element' ),
		...
		$this->add_responsive_control(
			'exit_animation',
			[
				'label' => esc_html__( 'Exit Animation', 'news-element' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Animation Duration', 'news-element' ) . ' (sec)',
				'type' => Controls_Manager::SLIDER,
				'frontend_available' => true,
				'default' => [
					'size' => 1.2,
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__( 'Inside', 'news-element' ),
					'outside' => esc_html__( 'Outside', 'news-element' ),
				],
				'frontend_available' => true,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Horizontal Position', 'news-element' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%', 'px' ],
				'range' => [
					'%' => [
		...
		$this->start_controls_tab(
			'tab_x_button_normal',
			[
				'label' => esc_html__( 'Normal', 'news-element' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Color', 'news-element' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_tab(
			'tab_x_button_hover',
			[
				'label' => esc_html__( 'Hover', 'news-element' ),
			]
		);
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => esc_html__( 'Size', 'news-element' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_advanced',
			[
				'label' => esc_html__( 'Advanced', 'news-element' ),
		...
		$this->add_control(
			'close_button_delay',
			[
				'label' => esc_html__( 'Show Close Button After', 'news-element' ) . ' (sec)',
		...
		$this->add_control(
			'close_automatically',
			[
				'label' => esc_html__( 'Automatically Close After', 'news-element' ) . ' (sec)',
				'type' => Controls_Manager::NUMBER,
				'min' => 0.1,
				'max' => 60,
				'step' => 0.1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Prevent Closing on Overlay', 'news-element' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Prevent Closing on ESC key', 'news-element' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'prevent_scroll',
			[
				'label' => esc_html__( 'Disable Page Scrolling', 'news-element' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Avoid Multiple Popups', 'news-element' ),
				'type' => Controls_Manager::SWITCHER,
				'description' => esc_html__( 'If the user has seen another popup on the page hide this popup', 'news-element' ),
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'open_selector',
			[
				'label' => esc_html__( 'Open By Selector', 'news-element' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( '#id, .class', 'news-element' ),
				'description' => esc_html__( 'In order to open a popup on selector click, please set your Popup Conditions', 'news-element' ),
				'frontend_available' => true,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'classes',
			[
				'label' => esc_html__( 'CSS Classes', 'news-element' ),
				'type' => Controls_Manager::TEXT,
				'title' => esc_html__( 'Add your custom class WITHOUT the dot. e.g: my-class', 'news-element' ),
				'frontend_available' => true,
			]
		);
