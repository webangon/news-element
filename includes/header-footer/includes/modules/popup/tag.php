	...
	public function register_controls() {
		$this->add_control(
			...
			[
				...
				'default' => 'open',
				'options' => [
					'open' => esc_html__( 'Open Popup', 'news-element' ),
					'close' => esc_html__( 'Close Popup', 'news-element' ),
					'toggle' => esc_html__( 'Toggle Popup', 'news-element' ),
				],
			]
		);
		...
		$this->add_control(
			'do_not_show_again',
			[
				'label' => esc_html__( 'Don\'t Show Again', 'news-element' ),
